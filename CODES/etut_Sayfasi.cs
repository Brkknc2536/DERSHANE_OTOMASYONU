...
// sql kütüphanemizi projemize ekledik
using System.Data.SqlClient;
namespace Birebir_Etut_Programi
{
    public partial class etut_Sayfasi : Form
    {
        //sql bağlantı nesnemizi oluşturduk
        sqlbaglantisi bgl = new sqlbaglantisi();

        //yapacağımız zaman işlemleri için değişkenler oluşturduk
        TimeSpan fark;
        double farkGun;
        public etut_Sayfasi()
        {
        ...
        void Listele()//top 20 etütü göstermesi için birden fazla tablonun birincil ve ikincil anahtarlarını bağlayarak listeleme işlemi için fonksiyonumuzu oluşturduk
        {
        ...
        void DersListele()//dersleri listeleyen fonksiyonumuzu hazırladık
        {
        ...
        void OgrenciListele()//öğrencileri listeleyen fonksiyonumuzu hazırladık
        {
        ...
        void Renklendir()//çalışma süresi geçen öğrencilerin belirlenmesi için datagridwiew sutunlarını renklendirme işlemi yaptık
        {
        ...
        {
            //oluşturduğumuz fonksiyonları çağırma işlemi yaptık
