...
namespace Birebir_Etut_Programi
{
    public partial class ogrenci_Sayfasi : Form
    {
        ...
        //öğrencileri diğer tablolardaki bilgilerinide alaraktan listeleme işlemine tabi tuttuk
        void Listele()
        {
        ...
        //sınıfları listeledik// buradaki amaç combobaxlara bu verileri çekerek ekleme güncelleme işlemleri için verileri tutmak
        void SinifListele()
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (secim == DialogResult.Yes)
            {
                ...
                {
                    try//öğrenci ekleme işlemini gerçekleştirdik
                    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (secim == DialogResult.Yes)
            {
                ...
                {
                    try//öğrenci güncelleme işlemini gerçekleştirdik
                    {
        ...
        private void TxtSilinecek_Click(object sender, EventArgs e)
        {
            ...
            if (secim == DialogResult.Yes)
            {
                ...
                {
                    try//öğrenci silme işlemini gerçekleştirdik
                    {
