...
//sql kütüphanemizi ekledik
using System.Data.SqlClient;
namespace Birebir_Etut_Programi
{
    public partial class ogretmenler_Sayfasi : Form
    {  //sqlbaglantisi sınıfından bağlantı nesnesi türettik
        sqlbaglantisi bgl = new sqlbaglantisi();
        public ogretmenler_Sayfasi()
        {
            InitializeComponent();
        } //öğretmenlerin diğer tablolardaki bilgilerinide alaraktan listeleme işlemine tabi tuttuk
        void Listele()
        {
        ...
        //branşları listeledik // buradaki amaç combobaxlara bu verileri çekerek ekleme güncelleme işlemleri için verileri tutmak
        void BransListele()
        {
        ...
        {//yazdığımız fonksiyonları çağırdık
            Listele();
            BransListele();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (secim == DialogResult.Yes)
            {
                ...
                {
                    try
                    {//sql komutu ile ekleme işlemini yaptık
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (secim == DialogResult.Yes)
            {
                ...
                {
                    try
                    {//sql komutu ile güncelleme işlemini yaptık
        ...
        private void TxtSilinecek_Click(object sender, EventArgs e)
        {
            ...
            if (secim == DialogResult.Yes)
            {
                ...
                {
                    try
                    {//sql komutu ile silme işlemini yaptık
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            try
            {//datagridwiewde tıklanan satırın toolboxdan eklediğimiz araçlara eklenmesi için komutumuzu yazdık
